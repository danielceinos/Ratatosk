...
data class AcceptConnectionAction(val connectionInitiated: RxNearbyConnections.ConnectionInitiated, val task: Task) :
    Action

data class ConnectionResultAction(val endpointId: String, val task: Task) : Action
